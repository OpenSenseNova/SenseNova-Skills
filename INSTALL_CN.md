...
如果 agent 能列出 `sn-infographic`、`sn-ppt-entry`、`sn-deep-research`、`sn-motion-html`、`sn-team-harness` 等本仓库的 skill，说明 LLM 与 skill 都已就绪。`sn-deepresearch-cli` 还需要按照对应指南额外安装独立 CLI。
