...
metadata:
  openclaw:
    ...
    envVars:
      - name: SN_API_KEY
        required: true
        description: "SenseNova API key used for the vision model that captions images."
      - name: SN_BASE_URL
        required: false
        description: "API base URL; defaults to https://token.sensenova.cn/v1."
      - name: SN_VISION_API_KEY
        required: false
        description: "Overrides SN_API_KEY for the vision model only."
      - name: SN_VISION_BASE_URL
        required: false
        description: "Overrides SN_BASE_URL for the vision model only."
      - name: SN_VISION_MODEL
        required: false
        description: "Vision model name; defaults to sensenova-6.7-flash-lite."
---
