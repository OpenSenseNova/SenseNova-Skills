...
1. [unit_id or global] 问题描述
   problem_type: missing_unit | citation_leak | reference_section | unit_format_mismatch | organization_mismatch | unsupported_certainty | broken_information_path | L0_conflict
