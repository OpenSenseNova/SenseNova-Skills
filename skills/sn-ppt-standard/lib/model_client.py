...
class LLMConfig:
    ...
    def from_env(cls) -> "LLMConfig":
        return cls(
            api_key=_env("SN_TEXT_API_KEY", "SN_CHAT_API_KEY", "LLM_API_KEY", "OPENAI_API_KEY"),
            base_url=_env(
                "SN_TEXT_BASE_URL",
                "SN_CHAT_BASE_URL",
                "LLM_BASE_URL",
            ...
            model=_env("SN_TEXT_MODEL", "SN_CHAT_MODEL", "LLM_MODEL_ID", default=_DEFAULT_CHAT_MODEL),
...
class VLMConfig:
    ...
    def from_env(cls) -> "VLMConfig":
        return cls(
            api_key=_env("SN_VISION_API_KEY", "SN_CHAT_API_KEY", "LLM_API_KEY", "OPENAI_API_KEY"),
            base_url=_env(
                "SN_VISION_BASE_URL",
                "SN_CHAT_BASE_URL",
                "LLM_BASE_URL",
            ...
            model=_env("SN_VISION_MODEL", "SN_CHAT_MODEL", "LLM_MODEL_ID", default=_DEFAULT_CHAT_MODEL),
