...
```bash
python3 /path/to/md-to-html-report/scripts/render_report.py input.md output.html
```
...
```bash
python3 /path/to/md-to-html-report/scripts/check_image_refs.py output.html
```
