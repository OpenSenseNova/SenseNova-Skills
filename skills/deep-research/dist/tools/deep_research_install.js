...
export function deepResearchInstallTool(params) {
    return {
        name: "deep_research_install",
        label: "Deep Research: install or repair",
        description: "Bootstrap or repair the Deep Research plugin assets under ~/.openclaw, including helper skills, agent workspaces, and openclaw.json config.",
        parameters: {
            type: "object",
...
//# sourceMappingURL=deep_research_install.js.map