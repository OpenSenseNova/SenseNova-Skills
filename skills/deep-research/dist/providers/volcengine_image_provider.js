...
export function buildVolcengineImageProvider() {
    return {
        id: PROVIDER_ID,
        ...
        async generateImage(req) {
            ...
            if (!apiKey) {
                throw new Error("Volcengine 图像生成缺少 API Key：请设置环境变量 ARK_API_KEY（或 VOLCANO_ENGINE_API_KEY）");
            }
...
//# sourceMappingURL=volcengine_image_provider.js.map