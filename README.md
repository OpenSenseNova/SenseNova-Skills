...
| [`sn-search-social-en`](skills/sn-search-social-en/SKILL.md) | English Social Search  | Reddit / Twitter (X) / YouTube search, plus optional Xquik-native routes for OpenClaw and Hermes Agent.                                    |
